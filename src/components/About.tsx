                    ...
                    <div className="grid md:grid-cols-[1.5fr_1fr] gap-12 items-center">
                        <div className="flex flex-col gap-12 order-2 md:order-1">
                            ...
                            <div>
                                ...
                                <ul className="grid sm:grid-cols-2 gap-4 text-gray-600 dark:text-gray-400">
                        ...
                        <div className="order-1 md:order-2 flex justify-center">
                            <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-2xl overflow-hidden glass p-2 transition-transform duration-300 hover:scale-[1.02]">
