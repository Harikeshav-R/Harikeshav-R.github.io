...
export const projects: Project[] = [
  ...
  },
  {
    ...
    slug: "arbos",
    name: "ArbOS",
    tagline: "Automated prediction-market logical arbitrage engine",
    ext: "rs",
    featured: true,
    description:
      "A low-latency, AI-augmented logical-arbitrage system that exploits probability-axiom violations across up to 1,000 live Polymarket order books for delta-neutral, mathematically guaranteed profit. A polyglot monorepo — Rust for the microsecond execution path, a Python watsonx.ai 'Brain' that maps the hidden graph of logical relationships between markets via LangGraph, and a React 19 control room — hardened with Fill-or-Kill execution, circuit breakers, and exact fixed-point math.",
    stats: [
      { value: "~14 ms", label: "end-to-end detection" },
      { value: "1,000", label: "live order books" },
    ],
    tech: [
      "Rust / Tokio",
      "IBM watsonx.ai",
  ...
  },
  {
    ...
    slug: "sprout",
    name: "Sprout",
    tagline: "Autonomous multi-agent AI platform for small farms",
    ext: "py",
    featured: false,
    description:
      "An AI-native platform giving small and independent farms an enterprise-grade digital workforce — a fleet of 5 stateful LangGraph agents automating competitive intelligence, brand/website generation, market forecasting, B2B sales outreach, and voice-to-CRM. Backed by a genuine SciPy forecasting service (OLS regression with true 95% prediction intervals — not an LLM guess) and a human-in-the-loop SDR pipeline on an async FastAPI + PostgreSQL stack.",
    stats: [],
    tech: [
      "LangGraph",
      "OpenRouter",
